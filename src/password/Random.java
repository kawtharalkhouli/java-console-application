...
public class Random {
    ...
    public Random(boolean IncludeUpper, boolean IncludeLower, boolean IncludeNum, boolean IncludeSym) {
        alphabet = new AlphabetSelection(IncludeUpper, IncludeLower, IncludeNum, IncludeSym);
    }
    ...
    private StrengthCheck GeneratePassword(int length) {
        ...
        return new StrengthCheck(pass.toString());
    }
    ...
    private void requestPassword() {
        ...
        do {
            ...
            final Random generator = new Random(IncludeUpper, IncludeLower, IncludeNum, IncludeSym);
            final StrengthCheck password = generator.GeneratePassword(length);
    ...
    private void checkPassword() {
        ...
        final StrengthCheck p = new StrengthCheck(input);
